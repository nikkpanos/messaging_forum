...
<html>
    ...
    <body>
        <header container class="siteHeader">
            <div row>
                <h1 column=4 class="logo" style="font-size:50px"><a href="index.php">e - BOOKING</a></h1>
                <nav column="8" class="nav">
                    <ul>
                        <li><a href="home.php">Αρχική Σελίδα</a></li>
                        <?php
                            if (isloggedin() && !is_public_page()){
                                print '<li><a href="rooms.php">Αναζήτηση Δωματίων</a></li>'; print("\n");
